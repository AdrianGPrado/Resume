...
\vspace{-0.8em}
\Description{Thesis: \textit{CUDA implementation of integration rules within an hp-Finite Element code.}}

\vspace{-0.8em}
\Description{This master course aims to develop different skills, such as data mining, neuronal networks, applied statistics, and optimization. It is remarkable, the fact that this work forced me to learn how to look for scientific publications and been able to study, understand and rapidly implement the code from the papers information.}

\vspace{-0.8em}
\Description{With my thesis project, I have obtained a deep formation in Finite Element Modeling. Under David Pardo \& Ricardo Celorrio's direction. My master thesis was an implementation of a FEM integration problem using CUDA technology. With this work, I acquired the necessary skills to develop FEM simulation software.}
\vspace{-0.8em}
\Description{The master course it is oriented form an applied mathematical point of view, and it is supported by several enterprises where the more outlined are DEIMOS-SPACE, and GAMESA.}
\vspace{-0.8em}
\Description{European Official Master, 60 ects credits.}
\vspace{-0.8em}
\Description{Advisors: Prof.~David \textsc{Pardo}  \ \ $\&$ \ \  Prof.~Ricardo \textsc{Celorrio}}
\vspace{-1.0em}
...
\vspace{-0.8em}
\Description{I learnt to simulate physical systems in C \& C++, including Monte-Carlo simulation methods, and FEM simulation methods, differential equation mathematical models, non linear dynamical equations. Particle physics, nuclear physics, radiation protection and dosimetry, statistical behavior of atoms and molecules, thermodynamic, magnetism, laser, optics, solid state physics, quantum mechanics.}
\vspace{-0.8em}
\Description{I learnt to: (a) study and analyze different physical phenomena, and the corresponding governing laws, (b); to experiment with the properties of matter and sources or energy, (c); develop IT and industrial applications.}
